...
function MemberAvatar({ name, avatarUrl }: { name: string; avatarUrl: string | null }) {
  ...
  const initials = name
    ...
    .join('');
  return (
    <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[rgba(var(--accent-rgb),0.18)] text-[10px] font-bold text-[var(--accent-secondary)]">
  ...
  const renderChannelCard = (channel: ChannelRow) => {
    ...
    return (
      ...
      >
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-[rgba(var(--accent-rgb),0.08)] pt-3">
          {owner ? (
          ...
          <select
            ...
            className="min-w-0 flex-1 rounded-lg border border-[rgba(var(--accent-rgb),0.2)] bg-[rgba(15,18,35,0.8)] px-3 py-1.5 text-xs text-[var(--color-text-primary)] focus:border-[var(--accent-primary)] focus:outline-none"
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-[rgba(var(--accent-rgb),0.08)] pt-3">
          <Bot
            ...
            style={{ color: channel.ai_enabled ? 'var(--accent-secondary)' : 'var(--color-text-secondary)' }}
          />
          <div className="min-w-0 flex-1">
      ...
      <section>
        <div className="glass-card space-y-4 p-5">
          ...
          <div className="rounded-xl border border-[rgba(var(--accent-rgb),0.15)] bg-white/[0.02] p-4">
            ...
            >
              <KeyRound className="h-4 w-4 shrink-0 text-[var(--accent-secondary)]" />
              <div className="min-w-0 flex-1">
            ...
            {showZernioKey ? (
              <div className="mt-3 space-y-3 border-t border-[rgba(var(--accent-rgb),0.08)] pt-3">
                <input
                  value={zernioKey}
            ...
            />
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className="rounded-lg border border-[rgba(var(--accent-rgb),0.2)] px-4 py-2 text-sm text-[var(--color-text-secondary)]"
                >
                  Cancelar
                </button>
                <button
