  ...
  return (
    <Card>
      <div className="space-y-6">
        ...
        <label className="flex items-center gap-3 rounded-lg border border-[rgba(var(--accent-rgb),0.15)] bg-white/[0.02] px-4 py-3 cursor-pointer">
          <input
            type="checkbox"
            checked={enabled}
                ...
                <ul className="space-y-1.5">
                  {queue.map((uid, i) => (
                    <li
                      ...
                      onDrop={() => onDrop(i)}
                      className="flex items-center gap-2 rounded-lg border border-[rgba(var(--accent-rgb),0.15)] bg-white/[0.02] px-3 py-2"
                    >
                  ...
                  {available.map((op) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-lg border border-[rgba(var(--accent-rgb),0.2)] px-2.5 py-1 text-xs font-medium text-[var(--accent-secondary)] transition hover:border-[var(--accent-primary)] hover:bg-white/5"
                      >
