        ...
        <div className="flex w-full flex-wrap items-center gap-2 sm:ml-auto sm:w-auto">
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-[rgba(var(--accent-rgb),0.25)] bg-white/[0.03] px-3 py-2 text-sm text-[var(--color-text-primary)] transition hover:border-[var(--accent-primary)]"
            >
              {pipeline?.name ?? 'Funil'}
            ...
            {pickerOpen && (
              <>
                ...
                <div className="absolute right-0 z-20 mt-1 w-56 rounded-lg border border-[rgba(var(--accent-rgb),0.25)] bg-[#0A0A0F] p-1 shadow-[0_0_30px_rgba(var(--accent-rgb),0.15)]">
                  {pipelines.map((p) => (
                    <button
                      key={p.id}
          ...
          {stages.map((stage) => {
            ...
            return (
              <div
                ...
                className="flex w-72 shrink-0 flex-col rounded-xl border border-[rgba(var(--accent-rgb),0.12)] bg-white/[0.02]"
              >
...
function ArchivedPanel({
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col border-l border-[rgba(var(--accent-rgb),0.2)] bg-[#0A0A0F] shadow-[0_0_60px_rgba(var(--accent-rgb),0.15)]">
        ...
        <div className="flex-1 space-y-2 overflow-y-auto p-4">
          ...
          {deals.map((d) => {
            ...
            return (
              <div key={d.id} className="rounded-xl border border-[rgba(var(--accent-rgb),0.2)] p-3" style={{ background: '#0F1223' }}>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute bottom-2 right-2 rounded-md border border-[rgba(var(--accent-rgb),0.25)] p-1 text-[var(--color-text-secondary)] opacity-0 transition group-hover:opacity-100 hover:bg-white/10 hover:text-[var(--color-text-primary)]"
        style={{ background: '#0F1223' }}
      >
...
function AddDealForm({
  ...
  const inputCls =
    'w-full rounded-md border border-[rgba(var(--accent-rgb),0.2)] bg-white/[0.03] px-2 py-1 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--accent-primary)]';
  ...
  return (
    <form
      ...
      className="space-y-2 rounded-lg border border-[rgba(var(--accent-rgb),0.2)] bg-white/[0.03] p-2"
    >
